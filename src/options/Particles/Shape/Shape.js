...
export class Shape {
  ...
  get image() {
    var _a;
    return (_a = this.options[ShapeType.image]) !== null && _a !== void 0
      ? _a
  ...
  get character() {
    var _a;
    return (_a = this.options[ShapeType.character]) !== null && _a !== void 0
      ? _a
  ...
  get polygon() {
    var _a;
    return (_a = this.options[ShapeType.polygon]) !== null && _a !== void 0
      ? _a
  ...
  load(data) {
    ...
    if (options !== undefined) {
      for (const shape in options) {
        ...
        if (item !== undefined) {
          this.options[shape] = Utils.deepExtend(
  ...
  loadShape(item, mainKey, altKey, altOverride) {
    ...
    if (item instanceof Array) {
      ...
      this.options[mainKey] = Utils.deepExtend(
        (_a = this.options[mainKey]) !== null && _a !== void 0 ? _a : [],
        item
      );
      if (!this.options[altKey] || altOverride) {
        this.options[altKey] = Utils.deepExtend(
